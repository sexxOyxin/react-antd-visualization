    ...
    getPopulationData()
      .then((res) => {
        ...
        const sortedData = res.data
          .filter((country) => country.population) // 确保有数据
          .sort((a, b) => b.population - a.population) // 按人口降序排序
          .slice(0, 10); // 取前10个

        setChartData({
          countries: sortedData.map((c) => c.name.common), // 提取国家名
          populations: sortedData.map((c) => c.population), // 提取人口数据
        });
      })
